...
<div class="bg-white h-[151px] shadow-none drop-shadow-lg rounded-3xl mt-10 p-6 flex justify-center space-x-16">
    ...
    <div class="flex items-center space-x-4">
        ...
        <div>
            ...
            <a href="">
                <div class="text-sm font-bold text-red-700"><span><i class="fa-solid fa-download text-green-500 mx-auto"></i></span> Download</div>
            </a>
        </div>
    </div>
    ...
    <div class="flex items-center space-x-4">
        ...
        <div>
            <div class="text-black font-semibold">Profit</div>
            <a href="">
                <div class="text-sm font-bold text-red-700"><span><i class="fa-solid fa-download text-green-500 mx-auto"></i></span> Download</div>
            </a>
        </div>
